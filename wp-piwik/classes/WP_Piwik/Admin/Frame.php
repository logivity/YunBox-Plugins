<?php
	...
	class Frame extends \WP_Piwik\Admin {
		...
		public function show() {
			echo '<iframe src="' . self::$settings->getGlobalOption ( 'piwik_url' ) . '/index.php?module=Widgetize&action=iframe&moduleToWidgetize=Dashboard&actionToWidgetize=index&idSite=' . self::$settings->getOption ( 'site_id' ) . '&period=week&date=yesterday&token_auth=' . self::$settings->getGlobalOption ( 'piwik_token' ) . '" frameborder="0" marginheight="0" marginwidth="0" width="100%" style="height:90vh;"></iframe>';
